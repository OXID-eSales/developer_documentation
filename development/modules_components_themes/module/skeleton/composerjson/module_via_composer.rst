...
please follow the
`blacklist-filter tests <https://github.com/OXID-eSales/oxideshop_ce/blob/b-6.5.x/tests/Integration/Internal/Framework/Module/Install/Service/ModuleFilesInstallerTest.php>`_
