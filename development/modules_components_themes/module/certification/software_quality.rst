...
Your code should be compatible with the PHP versions described in the `system requirements <https://docs.oxid-esales.com/eshop/en/6.4/installation/new-installation/server-and-system-requirements.html>`__.
