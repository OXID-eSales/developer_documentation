# -*- coding: utf-8 -*-
#
# OXID eShop developer documentation documentation build configuration file, created by
# sphinx-quickstart on Tue Dec 15 10:29:54 2015.
#
...
html_context = {
    ...
    'versions':
        [('6.2', 'https://docs.oxid-esales.com/developer/en/6.2/'),
         ...
         ('7.0-rc.2', 'https://docs.oxid-esales.com/developer/en/7.0-rc.2/'),
         ('master', 'https://docs.oxid-esales.com/developer/en/master/'),
         ('7.0-rc.1', 'https://docs.oxid-esales.com/developer/en/7.0-rc.2/'),
        ],
...
latex_documents = [
  (master_doc, 'OXIDeShopdeveloperdocumentation.tex', u'OXID eShop developer documentation',
   u'OXID eSales AG', 'manual'),
]
...
man_pages = [
    (master_doc, 'oxideshopdeveloperdocumentation', u'OXID eShop developer documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'OXIDeShopdeveloperdocumentation', u'OXID eShop developer documentation',
   author, 'OXIDeShopdeveloperdocumentation', 'One line description of project.',
   'Miscellaneous'),
]
