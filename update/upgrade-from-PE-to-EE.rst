...
**Affected versions**: OXID eShop 6.x and 7.x versions before 7.5
...
Run the following SQL script **before** step 3 (Run shop migrations):
...
Then continue with step 5 (Update your dependencies):
