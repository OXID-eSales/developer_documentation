...
ALTER TABLE `oxobject2group` CHANGE COLUMN `OXSHOPID` `OXSHOPID` int(11) NOT NULL default '1' COMMENT 'Shop id (oxshops)';
...
ALTER TABLE `oxshops` modify `OXID` int(11) NOT NULL default '1' COMMENT 'Shop id';
