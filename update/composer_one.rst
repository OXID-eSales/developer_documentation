Switch OXID eShop Compilation 6.0.x  from Composer 1 to Composer 2
==================================================================
...
#. Please update your system to use the highest compatible PHP version, which is PHP 7.0 for OXID eShop Compilation 6.0.6.
...
.. important::
   ...
   .. code:: shell
     ...
     composer require --no-update oxid-esales/oxideshop-unified-namespace-generator v1.1.0
